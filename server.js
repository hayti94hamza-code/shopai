...
// ============================================
//  EMBED.HTML ROUTE - Served directly from code
// ============================================
    ...
    <div class="container">
        ...
        <div class="widget-preview" id="widgetContainer">
            <div style="text-align:center;padding:2rem;color:#6b7280;">
                Click "Get Widget Code" to see the embed code
            </div>
        </div>
    ...
    <script>
        ...
        async function generateReviews() {
            ...
            try {
                ...
                fetchStats();
                document.getElementById('widgetContainer').innerHTML = \`<div style="text-align:center;padding:2rem;color:#10b981;">✅ \${data.totalReviews} reviews generated! Click "Get Widget Code" to embed.</div>\`;
            } catch (e) {
                showToast('❌ Error generating reviews');
            } finally {
                btn.textContent = '🚀 Generate 500 Reviews';
                btn.disabled = false;
            }
        }
        ...
        async function clearReviews() {
            ...
            try {
                ...
                showToast('❌ Error clearing reviews');
            }
        }
        ...
        async function getWidgetCode() {
            try {
                ...
                showToast('❌ Error generating widget code');
            }
        }
